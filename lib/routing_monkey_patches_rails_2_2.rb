# patches for Rails 2.2 to generate named route helpers lazily
...
module ::ActionController
  module Routing
    ...
    class Route
      ...
      def create
        unless frozen?
          # don't do that: # write_generation!
          write_recognition!
          prepare_matching!
      ...
      class NamedRouteCollection
        ...
        def define_hash_access(route, name, kind, options)
          ...
          code = <<-"end_code"
            ...
            # protected :#{selector}
          end_code
          add_generated_code code, "hash_access", "#{RAILS_ROOT}/vendor/rails/actionpack/lib/action_controller/routing/route_set.rb", 141
          helpers << selector
        end
        ...
        def define_url_helper(route, name, kind, options)
          ...
          code = <<-"end_code"
            ...
            # protected :#{selector}
          end_code
          add_generated_code code, "url_helper", "#{RAILS_ROOT}/vendor/rails/actionpack/lib/action_controller/routing/route_set.rb", 169
          helpers << selector
        end
      end
    end
